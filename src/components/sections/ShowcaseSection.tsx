        ...
        <div>
          ...
          <div className="flex flex-col">
            ...
            >
              ...
              <div className="relative bg-secondary text-white p-4 shadow-md rounded-lg overflow-hidden border justify-center items-center flex border-gray-200 hover:shadow-lg transition duration-300 cursor-pointer">
